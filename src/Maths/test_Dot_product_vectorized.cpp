...
TEST(Test_Dotprod128w2x4,dot_product_vectorized128w2){
    int vec[4];
    for (int i=0;i<4;i++){vec[i]=i;}
    ASSERT_EQ(14,dot_product_vectorized128w2(vec,4));
}

TEST(Test_Dotprod128w2x8,dot_product_vectorized128w2){
    int vec[8];
    for (int i=0;i<8;i++){vec[i]=i;}
    ASSERT_EQ(140,dot_product_vectorized128w2(vec,8));
}

TEST(Test_Dotprod128w2x16,dot_product_vectorized128w2){
    int vec[16];
    for (int i=0;i<16;i++){vec[i]=i;}
    ASSERT_EQ(1240,dot_product_vectorized128w2(vec,16));
}

TEST(Test_Dotprod128w2x32,dot_product_vectorized128w2){
    int vec[32];
    for (int i=0;i<32;i++){vec[i]=i;}
    ASSERT_EQ(10416,dot_product_vectorized128w2(vec,32));
}

TEST(Test_Dotprod128w2x64,dot_product_vectorized128w2){
    int vec[64];
    for (int i=0;i<64;i++){vec[i]=i;}
    ASSERT_EQ(85344,dot_product_vectorized128w2(vec,64));
}

TEST(Test_Dotprod128w2x100,dot_product_vectorized128w2){
    int vec[100];
    for (int i=0;i<100;i++){vec[i]=i;}
    ASSERT_EQ(328350,dot_product_vectorized128w2(vec,100));
}

TEST(Test_Dotprod128w2x1024,dot_product_vectorized128w2){
    int vec[1024];
    for (int i=0;i<1024;i++){vec[i]=i;}
    ASSERT_EQ(357389824,dot_product_vectorized128w2(vec,1024));
}
...
TEST(Test_Dotprod128w3x4,dot_product_vectorized128w3){
    float vec[4];
    for (int i=0;i<4;i++){vec[i]=i;}
    ASSERT_EQ(14,dot_product_vectorized128w3(vec,4));
}

TEST(Test_Dotprod128w3x8,dot_product_vectorized128w3){
    float vec[8];
    for (int i=0;i<8;i++){vec[i]=i;}
    ASSERT_EQ(140,dot_product_vectorized128w3(vec,8));
}

TEST(Test_Dotprod128w3x16,dot_product_vectorized128w3){
    float vec[16];
    for (int i=0;i<16;i++){vec[i]=i;}
    ASSERT_EQ(1240,dot_product_vectorized128w3(vec,16));
}

TEST(Test_Dotprod128w3x32,dot_product_vectorized128w3){
    float vec[32];
    for (int i=0;i<32;i++){vec[i]=i;}
    ASSERT_EQ(10416,dot_product_vectorized128w3(vec,32));
}

TEST(Test_Dotprod128w3x64,dot_product_vectorized128w3){
    float vec[64];
    for (int i=0;i<64;i++){vec[i]=i;}
    ASSERT_EQ(85344,dot_product_vectorized128w3(vec,64));
}

TEST(Test_Dotprod128w3x100,dot_product_vectorized128w3){
    float vec[100];
    for (int i=0;i<100;i++){vec[i]=i;}
    ASSERT_EQ(328350,dot_product_vectorized128w3(vec,100));
}
...
TEST(Test_Dotprod128w3x1024,dot_product_vectorized128w3){
    float vec[1024];
    for (int i=0;i<1024;i++){vec[i]=i;}
    ASSERT_EQ(357389920,dot_product_vectorized128w3(vec,1024));
}
...
TEST(Test_Dotprod256w1x8,dot_product_vectorized256iw1){
    int vec[8];
    for (int i=0;i<8;i++){vec[i]=i;}
    ASSERT_EQ(140,dot_product_vectorized256iw1(vec,8));
}

TEST(Test_Dotprod256w1x16,dot_product_vectorized256iw1){
    int vec[16];
    for (int i=0;i<16;i++){vec[i]=i;}
    ASSERT_EQ(1240,dot_product_vectorized256iw1(vec,16));
}

TEST(Test_Dotprod256w1x32,dot_product_vectorized256iw1){
    int vec[32];
    for (int i=0;i<32;i++){vec[i]=i;}
    ASSERT_EQ(10416,dot_product_vectorized256iw1(vec,32));
}

TEST(Test_Dotprod256iw1x64,dot_product_vectorized256iw1){
    int vec[64];
    for (int i=0;i<64;i++){vec[i]=i;}
    ASSERT_EQ(85344,dot_product_vectorized256iw1(vec,64));
}
...
TEST(Test_Dotprod256w1x1024,dot_product_vectorized256iw1){
    int vec[1024];
    for (int i=0;i<1024;i++){vec[i]=i;}
    ASSERT_EQ(353523200,dot_product_vectorized256iw1(vec,1024));
}
...
TEST(Test_Dotprod256w2x8,dot_product_vectorized256iw2){
    int vec[8];
    for (int i=0;i<8;i++){vec[i]=i;}
    ASSERT_EQ(140,dot_product_vectorized256iw2(vec,8));
}

TEST(Test_Dotprod256w2x16,dot_product_vectorized256iw2){
    int vec[16];
    for (int i=0;i<16;i++){vec[i]=i;}
    ASSERT_EQ(1240,dot_product_vectorized256iw2(vec,16));
}

TEST(Test_Dotprod256w2x32,dot_product_vectorized256iw2){
    int vec[32];
    for (int i=0;i<32;i++){vec[i]=i;}
    ASSERT_EQ(10416,dot_product_vectorized256iw2(vec,32));
}

TEST(Test_Dotprod256iw2x64,dot_product_vectorized256iw2){
    int vec[64];
    for (int i=0;i<64;i++){vec[i]=i;}
    ASSERT_EQ(85344,dot_product_vectorized256iw2(vec,64));
}
...
TEST(Test_Dotprod256w1x1024,dot_product_vectorized256iw2){
    int vec[1024];
    for (int i=0;i<1024;i++){vec[i]=i;}
    ASSERT_EQ(357389824,dot_product_vectorized256iw2(vec,1024));
} 
...
int main(int argc, char **argv) {
  ...
  //std::cout<<dot_product_vectorized256iw1(tt,16)<<std::endl; //output must be 204
  //std::cout<<dot_product_vectorized256iw2(tt,16)<<std::endl;
}
